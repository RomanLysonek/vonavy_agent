...
from skincare_advisor.managed_files import fsync_tree, verified_managed_file
...
def stage_static_export(
    ...
    report = {
        "schema_version": "1.0",
        "title": "Skincare Advisor evidence report",
        "runs": reports,
        "limitations": [
            ...
            "optional model is not executed by this built-in vertical slice.",
        ],
    }
...
<title>Skincare Advisor evidence report</title>
<style>
...
<body><main><div class="brand">Skincare Advisor</div>
<h1>Skincare Advisor evidence report</h1><p class="muted">Self-contained static export</p>
