...
class CatalogVersion(Base):
    ...
    parent_id: Mapped[str | None] = mapped_column(ForeignKey("catalog_versions.id"), nullable=True)
...
class CatalogMapping(Base):
    ...
    owner_id: Mapped[str] = mapped_column(String(128), default=LOCAL_OWNER_ID, index=True)
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=new_id)
    catalog_version_id: Mapped[str] = mapped_column(ForeignKey("catalog_versions.id"))
...
class DataProfile(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=new_id)
    catalog_version_id: Mapped[str] = mapped_column(ForeignKey("catalog_versions.id"))
    mapping_id: Mapped[str] = mapped_column(ForeignKey("catalog_mappings.id"))
