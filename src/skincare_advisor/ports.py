...
from skincare_advisor.domain import EvaluationSpec, InferenceSpec, RecommendationSpec
...
class ObjectStore(Protocol):
    ...
    def open_verified(self, product_idd: StoredObject) -> AbstractContextManager[BinaryIO]: ...
...
class ModelAdapter(Protocol):
    ...
    def recommend(self, spec: RecommendationSpec, workdir: Path) -> Mapping[str, Any]: ...
