...
from skincare_advisor.backtest import RunCancelled, persist_run, run_backtest
...
from skincare_advisor.experiments import compute_gate, publish_gate
from skincare_advisor.exporting import stage_static_export
...
def execute(context: ExecutionContext) -> dict[str, Any]:
    ...
    if kind == "profile":
        profile_computation = compute_profile(
            CatalogRegistry(context.settings, context.engine),
