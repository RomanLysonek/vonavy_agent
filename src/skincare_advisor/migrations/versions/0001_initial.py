"""Create initial local Skincare Advisor schema."""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("parent_id", sa.String(36), sa.ForeignKey("catalog_versions.id")),
    ...
    op.create_index("ix_catalog_mappings_mapping_hash", "catalog_mappings", ["mapping_hash"])
    op.create_table(
        "data_profiles",
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column(
        ...
        sa.Column(
            "mapping_id",
            sa.String(36),
            sa.ForeignKey("catalog_mappings.id"),
            nullable=False,
        ),
...
def downgrade() -> None:
    ...
    op.drop_index("ix_catalog_mappings_mapping_hash", table_name="catalog_mappings")
